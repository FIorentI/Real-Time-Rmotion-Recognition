...
def main():
    wandb.init(project="Emotion-recognition-FER2013-Training", name="MobileNetV2-Training-7")
    ...
    train_model(model, train_loader, val_loader, criterion, optimizer, scheduler, device, epochs, patience, model_dir,
                "FER_best_model.pth")
    torch.save(model.state_dict(), os.path.join(model_dir, "FER_last_model.pth"))
    ...
    save_run_details("training_results.txt", wandb.config, test_acc)
